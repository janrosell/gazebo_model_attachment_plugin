...
void ModelAttachmentPlugin::Load(physics::WorldPtr world, sdf::ElementPtr sdf)
{
    ...
    attach_srv_ = node_->create_service<gazebo_model_attachment_plugin::srv::Attach>(
        "/gazebo/attach",
        std::bind(&ModelAttachmentPlugin::attachCallback, this, std::placeholders::_1, std::placeholders::_2));
    detach_srv_ = node_->create_service<gazebo_model_attachment_plugin::srv::Detach>(
        "/gazebo/detach",
...
bool ModelAttachmentPlugin::attachCallback(
    const std::shared_ptr<gazebo_model_attachment_plugin::srv::Attach::Request> req,
    std::shared_ptr<gazebo_model_attachment_plugin::srv::Attach::Response> res)
{
    ...
    auto m1 =
        std::find_if(models.begin(), models.end(),
                     [&model_1_name](const gazebo::physics::ModelPtr& ptr) { return ptr->GetName() == model_1_name; });
    if (m1 == models.end())
    {
    ...
    auto m2 =
        std::find_if(models.begin(), models.end(),
                     [&model_2_name](const gazebo::physics::ModelPtr& ptr) { return ptr->GetName() == model_2_name; });
    if (m2 == models.end())
    {
...
bool ModelAttachmentPlugin::detachCallback(
    const std::shared_ptr<gazebo_model_attachment_plugin::srv::Detach::Request> req,
